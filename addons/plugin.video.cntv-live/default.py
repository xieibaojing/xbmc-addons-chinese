...
def CATEGORIES():
         ...
         addDir('卫视直播','/live_h/index.shtml',6,os.getcwd()+'\\resources\\media\\live-startv.png',True)
...
def LiveChannel(url,name):
         if name=='央视直播':
                 ...
                 addDir(name+'>CCTV3文艺频道',"pl://cctv_p2p_hdcctv3",7,os.getcwd()+'\\resources\\media\\cctv3.png')
                 addDir(name+'>CCTV4亚洲国际',"pl://cctv_p2p_hdcctv4",7,os.getcwd()+'\\resources\\media\\cctv4.png')
                 addDir(name+'>CCTV4欧洲国际',"pl://cctv_p2p_hdcctv4euro",7,os.getcwd()+'\\resources\\media\\cctv4o.png')
                 addDir(name+'>CCTV4美洲国际',"pl://cctv_p2p_hdcctv4america",7,os.getcwd()+'\\resources\\media\\cctv4a.png')
                 addDir(name+'>CCTV5体育频道',"pa://cctv_p2p_hdcctv5",7,os.getcwd()+'\\resources\\media\\cctv5.png')
                 addDir(name+'>CCTV6电影频道',"pl://cctv_p2p_hdcctv6",7,os.getcwd()+'\\resources\\media\\cctv6.png')
                 addDir(name+'>CCTV7军事频道',"pa://cctv_p2p_hdcctv7",7,os.getcwd()+'\\resources\\media\\cctv7.png')
                 addDir(name+'>CCTV8电视剧频道',"pl://cctv_p2p_hdcctv8",7,os.getcwd()+'\\resources\\media\\cctv8.png')
                 addDir(name+'>CCTV9英语国际',"pl://cctv_p2p_hdcctv9",7,os.getcwd()+'\\resources\\media\\cctv9.png')
                 addDir(name+'>CCTV10科教频道',"pl://cctv_p2p_hdcctv10",7,os.getcwd()+'\\resources\\media\\cctv10.png')
                 addDir(name+'>CCTV11戏曲频道',"pl://cctv_p2p_hdcctv11",7,os.getcwd()+'\\resources\\media\\cctv11.png')
                 addDir(name+'>CCTV12法制频道',"pl://cctv_p2p_hdcctv12",7,os.getcwd()+'\\resources\\media\\cctv12.png')
                 addDir(name+'>CCTV少儿频道',"pl://cctv_p2p_hdcctvkids",7,os.getcwd()+'\\resources\\media\\cctvshaoer.png')
                 addDir(name+'>CCTV新闻频道',"pa://cctv_p2p_hdcctvnews",7,os.getcwd()+'\\resources\\media\\cctvnews.png')
                 addDir(name+'>CNTV24小时体育',"pa://cctv_p2p264_sports",7,os.getcwd()+'\\resources\\media\\cctvsport.png')
                 addDir(name+'>CCTV音乐频道',"pl://cctv_p2p_hdcctvmusic",7,os.getcwd()+'\\resources\\media\\cctvmusic.png')
                 addDir(name+'>CCTV高清频道',"pa://cctv_p2p_hdcctvgaoqing",7,os.getcwd()+'\\resources\\media\\cctvhd.png')
                 addDir(name+'>CCTV法语频道',"pl://cctv_p2p_cctvfayu",7,os.getcwd()+'\\resources\\media\\cctvf.png')
                 addDir(name+'>CCTV西班牙语频道',"pl://cctv_p2p_hdxiyu",7,os.getcwd()+'\\resources\\media\\cctve.png')
                 addDir(name+'>CCTV俄语频道',"pl://cctv_p2p_hd700_cctvrussian",7,os.getcwd()+'\\resources\\media\\cctveyu.png')
                 addDir(name+'>CCTV阿拉伯语频道',"pl://cctv_p2p_hd700_cctvarabic",7,os.getcwd()+'\\resources\\media\\cctvayu.png')
                 addDir(name+'>CCTV中视购物频道',"pl://cctv_p2p_gouwu",7,os.getcwd()+'\\resources\\media\\cctvgouwu.png')
                 addDir(name+'>CCTV风云足球频道',"pa://cctv_p2p_hdcctvfyzq",7,os.getcwd()+'\\resources\\media\\cctvfootball.png')
                 addDir(name+'>CCTV高尔夫频道',"pa://cctv_p2p_hdcctvgaowang",7,os.getcwd()+'\\resources\\media\\cctvgolf.png')
         elif name=="卫视直播":
                 ...
                 addDir(name+'>山东教育',"pl://cctv_p2p_shandongjiaoyu",7,os.getcwd()+'\\resources\\media\\shandong.png')
                 addDir(name+'>陕西卫视',"pl://cctv_p2p_hdshanxi",7,os.getcwd()+'\\resources\\media\\shan_xi.png')
                 ...
                 addDir(name+'>西藏卫视',"pl://cctv_p2p_hdxizang2",7,os.getcwd()+'\\resources\\media\\xizang.png')
                 ...
                 addDir(name+'>厦门卫视',"pl://cctv_p2p_xiamenweishi",7,os.getcwd()+'\\resources\\media\\xiamen.png')
                 addDir(name+'>成都新闻',"pa://cctv_p2p_cdtv1",7,os.getcwd()+'\\resources\\media\\sichuan.png')
                 addDir(name+'>成都公共',"pa://cctv_p2p_cdtv5",7,os.getcwd()+'\\resources\\media\\sichuan.png')
                 addDir(name+'>厦门一套',"pl://cctv_p2p_xiamen1",7,os.getcwd()+'\\resources\\media\\xiamen.png')
                 addDir(name+'>厦门二套',"pl://cctv_p2p_xiamen2",7,os.getcwd()+'\\resources\\media\\xiamen.png')
