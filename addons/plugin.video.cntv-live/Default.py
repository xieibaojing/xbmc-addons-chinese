...
def LiveChannel(url,name):
         if name=='央视直播':
                 ...
                 addDir(name+'>CCTV新闻频道',"pa://cctv_p2p_hdcctvnews",7,os.getcwd()+'\\resources\\media\\xinwen.jpg')
                 addDir(name+'>CNTV24小时体育',"pa://cctv_p2p264_sports",7,os.getcwd()+'\\resources\\media\\24tiyu.jpg')
                 ...
                 addDir(name+'>CCTV风云足球频道',"pa://cctv_p2p_hdcctvfyzq",7,os.getcwd()+'\\resources\\media\\noname.jpg')
